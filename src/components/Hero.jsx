      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
        <div className="text-center">
          ...
          <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            Graduating Boston University in May 2025 with a B.S. in Computer Engineering with a concentration in machine learning.
            Passionate about creating innovative solutions in ML/AI, cloud computing, and data science.
          </p>
